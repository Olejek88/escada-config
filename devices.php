<?php
 if ($_GET["ud"]=='1')
	{
	 $query = 'DELETE FROM device WHERE idd='.$_GET["id"];
 ...
 if ($_POST["frm"]=='1')
	...
	<?php	
	 print '<th class="ds_name sort_none" align="center">ID</th>
		<th class="ds_last sort_none" align="center">Name</th>
	        ...
	        <th class="ds_change sort_none" align="center">Del</th>';
	?>
	</tr></thead>
	<tbody>
	...
	<?php
	 ...
	 while ($uy = mysql_fetch_assoc ($a))
		{
		 print '<tr class="">';	
		 if ($device_table=='devices') print '<td class="ds_name qb_shad" align="left" nowrap="nowrap">'.$uy["device"].'</td>';
		 else print '<td class="ds_name qb_shad" align="left" nowrap="nowrap">'.$uy["idd"].'</td>';
			
		 print '<td class="ds_name qb_shad" align="left" nowrap="nowrap"><a href="index.php?sel=channels&device='.$uy["device"].'">'.$uy["name"].'</a></td>';
		...
		print '<td style="" class="ds_last qb_shad" align="center"><a href="index.php?sel=devices&ud=1&id='.$uy["idd"].'"><img border="0" src="files/delete.png"></td>';
		print '</tr>';
		$name='';
		}
	?>

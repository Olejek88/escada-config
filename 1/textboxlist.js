...
var TextboxList = Class.create({ 
  ...
  // This creates the box with the closing X on it after a user selects an item
  ...
  createInput: function(options) {
    ...
    el.value = 'Enter ticker symbol';
    el.style.position = 'relative';
    el.style.top = '2px';
    el.style.fontFamily = 'Arial,Helvetica,sans-serif';
    el.style.fontSize = '11px';
    el.observe('click', function(e) { e.stop(); this.value=''; this.style.fontStyle='normal';}).observe('focus', function(e) {  if(! this.isSelfEvent('focus')) this.focus(li, true); }.bind(this)).observe('blur', function() { if(! this.isSelfEvent('blur')) this.blur(true); }.bind(this)).observe('keydown', function(e) { this.cacheData('lastvalue', this.value).cacheData('lastcaret', this.getCaretPosition()); });
